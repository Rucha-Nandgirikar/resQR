...
app.get("/getLocationName", async (req, res) => {
  ...
  const apiUrlLocationName = `https://maps.googleapis.com/maps/api/geocode/json?latlng=${accidentLatitude},${accidentLongitude}&key=${key}`;
...
app.post("/send_email", (req, res) => {
  ...
  Immediate action has been taken, and nearby hospitals and police stations have been notified about the incident. We request your urgent assistance in reaching the accident location at ${accidentLatitude},${accidentLongitude} as soon as possible.
